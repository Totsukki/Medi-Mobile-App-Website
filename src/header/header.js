        ...
        return(
            <header>
                ...
                <div className='p-20 pt-44 text-white grid grid-cols-2 flex flex-col justify-center'>
                    <div className='left-side w-[80%] line-h-1 flex flex-col justify-center items-center'>
                        <h1 className='font-extrabold text-[10vh] leading-[5rem]'>Medicine Remind App</h1>
                        <p className='mt-7 w-[80% text-[3.5vh]'>Medi is a medicine reminder app that helps remind users to drink their medications.</p>
                        <button className='mt-6 py-[.5vw] px-[4vw] rounded-3xl self-start border-none text-white bg-[#215BF0]' type='button'>Get Started</button>
                    </div>
